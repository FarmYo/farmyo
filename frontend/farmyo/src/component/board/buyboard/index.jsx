    ...
    <div style={{height:'450px',position:'relative'}}>
      ...
      <Modal open={buyOpen} onClose={buyCloseModal} styles={styles}>
        <div className="mt-24">
          ...
          <div class="relative rounded-md mt-1">
            <input type="text" name="price" id="price" class="block h-12 w-full rounded-md border-0 pl-2 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" placeholder="가격을 입력하세요(/kg)"/>
          </div>
